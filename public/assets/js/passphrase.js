...
var words = null;
var global_hash_generated = false;
...
function populateform(enterlength) {
    //clear the previous error, if the hash wasnt generated
    ...
    global_hash_generated = true;
    // we may hve to set this
    //entropyOutput.textContent = password.entropy.toFixed(2);
    //for validaion needs encrypt button to be enables and to verify if the hash has been generated amd the vol is selected
