...
const contractAddress = "0xa505630672898f901A0c6B261A693C39f17e66B8"
...
/* maybe we want to check to see if teh hash already exisst - remember, in that case the Ethereum tranasaction will fail
...
async function loadEthers()
{
    ...
    */
    ...
    var mainContract = new ethers.Contract(contractAddress, LocationNFT.abi, wallet); //fromAddress
...
async function mint(location) 
{
    ...
    //let contractAddress = "0xa505630672898f901A0c6B261A693C39f17e66B8";
    ...
    try {
		...
		/*
          const nft2 = await mainContract.mintNFT(location) .send({ from: fromAddress })   //replace with `accAddress' from the config file
          .once('receipt', (receipt) => 
          {
